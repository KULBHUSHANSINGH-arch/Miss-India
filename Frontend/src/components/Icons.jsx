...
export const Inbox = (p) => <S {...p}><path d='M22 12h-6l-2 3h-4l-2-3H2' /><path d='M5.5 5.1 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.5-6.9A2 2 0 0 0 16.8 4H7.2a2 2 0 0 0-1.7 1.1Z' /></S>;
export const External = (p) => <S {...p}><path d='M15 3h6v6M10 14 21 3M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6' /></S>;
export const Newspaper = (p) => <S {...p}><path d='M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0a2 2 0 0 1-2-2v-9c0-1.1.9-2 2-2h2' /><path d='M18 14h-8M15 18h-5M10 6h8v4h-8Z' /></S>;
